...
Humidity humidity(DHTPIN);
TowerTemp temperature(ONE_WIRE_BUS);
WaterLevelSensor waterLevelSensor(&temperature, RES_RADIUS, RES_HEIGHT, ECHO_PIN, TRIG_PIN);
Scanner i2cScan;
